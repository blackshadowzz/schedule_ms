     ...
     <div class="modal-dialog modal-xl" style="width: 40%">
          <div class="modal-content">
               ...
               <div class="modal-body">
                    <form action="/subjects/store" method="post" class="" enctype="multipart/form-data">
                         @csrf
                    <div class="row">
                         <div class="col-12">
                              <!-- h -->
                              <div class="">
                                   ...
                                   <input type="text" name="subject_name" value="{{ old('subject_name') }}" class="form-control flex-col" id="subject_name" required placeholder="Subject name...">
                                   @error('subject_name')
                    ...
                    <div class="mt-2">
                         ...
                         <select name="course_id" class="form-control" id="course_id">
                              <option value="" style="display: none;">Choose course</option>
                              @foreach($course as $c)
                    ...
                    <div class="mt-2">
                         ...
                         <input type="text" name="description" value="{{ old('description') }}" id="description" class="form-control" required placeholder="Description...">
                         @error('description')
                         <span class="text-danger">{{ $message }}</span>
                         @enderror
                    </div>   
