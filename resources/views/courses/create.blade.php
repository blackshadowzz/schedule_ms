     ...
     <div class="modal-dialog modal-xl" style="width: 40%">
          <div class="modal-content">
               ...
               <div class="modal-body">
                    <form action="/courses" method="post" class="" enctype="multipart/form-data">
                         @csrf
                    <div class="row">
                         <div class="col-12">
                              <!-- h -->
                              <div class="">
                                   ...
                                   <input type="text" name="course_name" value="{{ old('course_name') }}" class="form-control flex-col" id="course_name" required placeholder="Course name...">
                                   @error('course_name')
